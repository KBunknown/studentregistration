      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex flex-1 items-center justify-center px-4 py-8 sm:px-6">
          <div className="w-full max-w-2xl">
            <div className="rounded-3xl border border-blue-100 bg-white/80 p-8 shadow-[0_24px_70px_rgba(21,94,239,0.1)] backdrop-blur-2xl sm:p-12 lg:p-16">
              <div className="flex flex-col items-center text-center">
                ...
                <h1 className="mt-8 font-heading text-3xl font-extrabold tracking-tight text-primary-navy sm:text-4xl lg:text-5xl">
                  {t("portal_title")}
                </h1>
        ...
        <footer className="px-6 pb-6 sm:px-10 lg:px-16">
          <div className="flex items-center justify-between border-t border-blue-200/50 pt-4">
            <span className="text-xs text-slate-500">{t("portal_title")}</span>
            <img
              src="/emblem.png"
              alt="Emblem"
              className="h-7 w-7 object-contain opacity-60 grayscale"
            />
          </div>
        </footer>
      </div>
