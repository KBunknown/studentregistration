  ...
  return (
    <AdminShell title="Programme Management">
      <p className="text-sm text-muted-foreground mb-6">
        Manage the list of approved BSc programmes available during registration.
      </p>

      <div className="glass-panel rounded-xl p-6 shadow-card">
        <h2 className="font-heading text-sm font-semibold text-primary-navy mb-4">
          Add new programme
        </h2>
      ...
      <div className="mt-8">
        <h2 className="font-heading text-sm font-semibold text-primary-navy mb-4">
          Active Programmes ({list.length})
        </h2>
        <div className="grid gap-3 sm:grid-cols-2">
          {list.map((p) => (
            <div
              key={p}
              className="flex items-center justify-between glass-panel rounded-xl p-4 shadow-sm transition hover:border-border/80"
            >
