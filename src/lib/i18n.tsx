...
export const dict = {
  portal_title: { en: "International Student Registration Portal", fr: "Portail d'inscription des étudiants internationaux" },
  ...
  landing_headline: { en: "Register for the upcoming academic year", fr: "Inscrivez-vous pour la prochaine année académique" },
  landing_sub: {
  ...
  landing_feature_1_d: { en: "Average time to complete the form.", fr: "Temps moyen pour remplir le formulaire." },
  landing_feature_2_t: { en: "Bilingual", fr: "Bilingue" },
  landing_feature_2_d: { en: "Available in English and French.", fr: "Disponible en anglais et en français." },
  landing_feature_3_t: { en: "Secure", fr: "Sécurisé" },
  landing_feature_3_d: { en: "Your data is handled per our privacy notice.", fr: "Vos données sont traitées selon notre avis de confidentialité." },

  form_title: { en: "Registration form", fr: "Formulaire d'inscription" },
  form_sub: { en: "Please provide accurate details. You will review before submitting.", fr: "Veuillez fournir des informations exactes. Vous pourrez vérifier avant l'envoi." },
  ...
  f_same_wa: { en: "My WhatsApp number is the same as my phone number", fr: "Mon numéro WhatsApp est identique à mon numéro de téléphone" },
  f_program: { en: "Program", fr: "Programme" },
  f_program_ph: { en: "Search and select your program", fr: "Rechercher et sélectionner votre programme" },
  ...
  review_sub: { en: "Confirm every field before submitting your registration.", fr: "Vérifiez chaque champ avant de soumettre votre inscription." },

  success_title: { en: "Registration successful", fr: "Inscription réussie" },
  success_sub: { en: "Your details have been recorded. Keep this summary for your records.", fr: "Vos informations ont été enregistrées. Conservez ce récapitulatif." },
  s_reg_date: { en: "Registration date", fr: "Date d'inscription" },

  already_title: { en: "Already registered?", fr: "Déjà inscrit ?" },
  already_sub: { en: "Enter your index number and email to view or update your registration.", fr: "Entrez votre numéro d'index et votre e-mail pour consulter ou mettre à jour votre inscription." },
  already_lookup: { en: "Look up my registration", fr: "Consulter mon inscription" },
  already_none: { en: "No registration matched those details.", fr: "Aucune inscription ne correspond à ces informations." },
  ...
  admin_login: { en: "Super Admin login", fr: "Connexion super administrateur" },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const saved = typeof window !== "undefined" ? (localStorage.getItem("isrp_lang") as Lang | null) : null;
