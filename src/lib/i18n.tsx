...
export const dict = {
  ...
  f_search: { en: "Search...", fr: "Rechercher..." },
  f_no_results: { en: "No results found.", fr: "Aucun résultat trouvé." },
  sec_personal: { en: "Personal", fr: "Personnel" },
  sec_personal_desc: { en: "Name, email, gender", fr: "Nom, e-mail, genre" },
  sec_contact: { en: "Contact", fr: "Contact" },
  sec_contact_desc: { en: "Country, phone, WhatsApp", fr: "Pays, téléphone, WhatsApp" },
  sec_academic: { en: "Academic", fr: "Académique" },
  sec_academic_desc: { en: "Programme, index, level", fr: "Programme, index, niveau" },
  err_highlighted: { 
    en: "Please correct the highlighted fields before continuing.", 
    fr: "Veuillez corriger les champs en surbrillance avant de continuer." 
  },
  sec_personal_info: { en: "Personal Information", fr: "Informations personnelles" },
  sec_contact_info: { en: "Contact Information", fr: "Coordonnées" },
  sec_academic_info: { en: "Academic Information", fr: "Informations académiques" },
  f_select_gender: { en: "Select gender", fr: "Sélectionner le genre" },
  f_select_level: { en: "Select level", fr: "Sélectionner le niveau" },
  f_calc_level: { en: "Calculated from your current level", fr: "Calculé à partir de votre niveau actuel" },
  already_found: { en: "Registration Found", fr: "Inscription trouvée" },
  f_name: { en: "Name", fr: "Nom" },
  ...
  f_select_country: { en: "Select a country", fr: "Sélectionner un pays" },
